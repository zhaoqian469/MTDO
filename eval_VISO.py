...
parser.add_argument('--data_dir', type=str, default='D:/ZhaoQian/datasets/VISO')
parser.add_argument('--file_list', type=str, default='VISO_test_11.txt')   #改这里！！！
...
parser.add_argument('--output', default='Results/VISO_Y/MTDO', help='Location to save checkpoint models')  #改这里！！
...
def eval():
    ...
    #
        ...
        if (count) == 99:
            ...
            txt_file = os.path.join(opt.output, "best_psnr-ssim_file_names.txt")
